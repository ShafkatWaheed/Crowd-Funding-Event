...
class _AdminSettingsTabState extends State<AdminSettingsTab>
  ...
  static const _tabDefs = [
    ...
    {'label': 'Infrastructure', 'icon': Icons.build_circle, 'groups': ['Cache', 'Offline / Sync', 'Infrastructure', 'Chat']},
  ...
  static const _settingsGroups = {
    ...
    'Cache': ['cache_enabled', 'cache_ttl_settings', 'cache_ttl_featured', 'cache_ttl_event_detail', 'cache_ttl_dashboard', 'cache_ttl_cities', 'cache_ttl_genres', 'cache_ttl_map', 'cache_ttl_admin_dashboard', 'cache_stampede_lock_ttl', 'cache_stampede_retry_ms', 'cache_beta_featured', 'cache_beta_event_detail', 'cache_beta_map', 'cache_beta_dashboard', 'cache_circuit_breaker_threshold', 'cache_circuit_breaker_cooldown'],
