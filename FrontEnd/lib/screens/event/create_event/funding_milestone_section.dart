...
class FundingMilestoneSection extends StatefulWidget {
  final List<MilestoneInput> milestones;

  const FundingMilestoneSection({
    super.key,
    required this.milestones,
  });

  @override
  State<FundingMilestoneSection> createState() =>
      _FundingMilestoneSectionState();
}

class _FundingMilestoneSectionState extends State<FundingMilestoneSection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        GestureDetector(
          onTap: () =>
              setState(() => _showMilestoneSection = !_showMilestoneSection),
          child: Container(
            padding:
            ...
            child: Column(
              ...
              children: [
                ...
                ...widget.milestones.asMap().entries.map((entry) {
                  ...
                  return _buildMilestoneCard(context, idx, ms);
                }),
                GestureDetector(
                  onTap: () => setState(
  ...
  Widget _buildMilestoneCard(
      BuildContext context, int idx, MilestoneInput ms) {
    return Container(
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'e.g. Premium sound system for all attendees',
              isDense: true,
            ),
            maxLines: 2,
          ),
