...
class ScheduleSectionTickets extends StatefulWidget {
  ...
  @override
  State<ScheduleSectionTickets> createState() => _ScheduleSectionTicketsState();
}

class _ScheduleSectionTicketsState extends State<ScheduleSectionTickets> {
