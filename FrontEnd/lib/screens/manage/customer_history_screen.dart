...
class _CustomerHistoryScreenState extends State<CustomerHistoryScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final list = await _api.getOrganizerCustomers();
      setState(() {
            ...
            : Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        _statChip(Icons.people_rounded, '${items.length} customers', AppTheme.accentColor),
                  ...
                  Expanded(
                    child: items.isEmpty
                        ? Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('No customers yet', style: TextStyle(color: Colors.grey[500])),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (ctx, i) => _buildCustomerCard(items[i]),
                          ),
                  ),
                ],
              ),
    ...
    return Container(
      ...
      child: ListTile(
        leading: CircleAvatar(
          backgroundColor: isRepeat ? AppTheme.successColor : AppTheme.accentColor,
          child: Icon(
