...
- **Model tests:** `test/models/` — chat_message, **dashboard**, **discount**, event_form_models, event_image, event, funding, map_event, milestone, **notification_model**, post, **payment**, **rating**, **receipt**, schedule, sponsor, ticket_strategy, ticket, user, venue (JSON serialization, fromJson/toJson, equality).
