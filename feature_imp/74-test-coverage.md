...
- **Screen tests:** `test/screens/` — admin_dashboard, bid_chat, bid_management, bookmarked_events, conversations, create_event, edit_event, event_detail, explore_tab, funding_card, home, login, manage_screens, my_events_tab, my_pledges, my_tickets, notification, organizer_dashboard, profile, receipt_screens, register, splash, sponsor_dashboard, sponsor_onboarding, ticket_tiers_section, venue_screens; `widget_test.dart` (default Flutter test).
...
- **Domain test files:** `test_admin.py` (modified), `test_banking.py`, `test_chat.py`, `test_discounts.py`, `test_funding.py`, `test_images.py`, `test_lifecycle.py`, `test_migrations.py`, `test_milestones.py`, `test_misc_endpoints.py`, `test_notifications.py`, `test_organizers.py`, `test_posts.py`, `test_public_profiles.py`, `test_ratings.py`, `test_registration.py`, `test_schedule.py`, `test_sponsors.py`, `test_sponsors_extended.py`, `test_strategies.py` — each covers API endpoints for that domain (status codes, response shape, auth, edge cases).
